...
export const sendFriendRequest = async (req, res) => {
    try {
        ...
        console.error("[ERROR]: Lỗi khi gửi yêu cầu kết bạn!", error);
        res.status(500).json({
...
export const acceptFriendRequest = async (req, res) => {
    try {
        ...
        console.error("[ERROR]: Lỗi khi chấp nhận lời mời kết bạn!", error);
        res.status(500).json({
            message: "Lỗi hệ thống!",
        });
    }
...
export const declineFriendRequest = async (req, res) => {
    try {
        ...
        console.error("[ERROR]: Lỗi khi gửi từ chối kết bạn!", error);
        res.status(500).json({
            message: "Lỗi hệ thống!",
        });
    }
...
export const getAllFriends = async (req, res) => {
    try {
        ...
        console.error("[ERROR]: Lỗi khi lấy danh sách bạn bè!", error);
        res.status(500).json({
            message: "Lỗi hệ thống!",
        });
    }
...
export const getFriendRequests = async (req, res) => {
    try {
        ...
        console.error("[ERROR]: Lỗi khi lấy danh sách lời mời kết bạn!", error);
        res.status(500).json({
            message: "Lỗi hệ thống!",
        });
    }
